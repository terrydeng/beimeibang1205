...
SQL;
        ...
        $sql_insert = <<<SQL
INSERT INTO `{$prefix}advertising` VALUES ('15', '轻博客右侧底部广告', '1', '280px', '100px', '1', 'weibo_right_below_all', '0', 'all', '', '');
INSERT INTO `{$prefix}advertising` VALUES ('14', '签到下方广告', '1', '280px', '100px', '1', 'weibo_below_checkrank', '0', 'all', '0 0 10px 0', '');
INSERT INTO `{$prefix}advertising` VALUES ('13', '轻博客过滤右方', '3', '300px', '30px', '1', 'weibo_filter_right', '0', 'all', '', '');
...
SQL;
        ...
        /* if(count(D()->query("SHOW TABLES LIKE '".$this->table_name()."Advertising'")) != 1){
