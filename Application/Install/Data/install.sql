...
(10001, 'add_weibo', '发布轻博客', '新增轻博客', 'a:1:{i:0;a:5:{s:5:"table";s:6:"member";s:5:"field";s:1:"1";s:4:"rule";s:2:"+1";s:5:"cycle";s:2:"24";s:3:"max";s:2:"10";}}', '[user|get_nickname]在[time|time_format]发布了新轻博客：[record|intval]', 1, 1, 1437116716, 'Weibo'),
(10002, 'add_weibo_comment', '添加轻博客评论', '添加轻博客评论', 'a:1:{i:0;a:5:{s:5:"table";s:6:"member";s:5:"field";s:1:"1";s:4:"rule";s:2:"+1";s:5:"cycle";s:2:"24";s:3:"max";s:2:"10";}}', '[user|get_nickname]在[time|time_format]添加了轻博客评论：[record|intval]', 1, 1, 1437116734, 'Weibo'),
(10003, 'del_weibo_comment', '删除轻博客评论', '删除轻博客评论', '', '[user|get_nickname]在[time|time_format]删除了轻博客评论：[record|intval]', 1, 1, 1428399164, 'Weibo'),
(10004, 'del_weibo', '删除轻博客', '删除轻博客', '', '[user|get_nickname]在[time|time_format]删除了轻博客：[record|intval]', 1, 1, 1428461334, 'Weibo'),
(10005, 'set_weibo_top', '置顶轻博客', '置顶轻博客', '', '[user|get_nickname]在[time|time_format]置顶了轻博客：[record|intval]', 1, 1, 1428399164, 'Weibo'),
(10006, 'set_weibo_down', '取消置顶轻博客', '取消置顶轻博客', '', '[user|get_nickname]在[time|time_format]取消置顶了轻博客：[record|intval]', 1, 1, 1428462983, 'Weibo');
...
(3, 'add_weibo', '新增轻博客', 1, 10, 'second', 'warning', 0, '', '[add_weibo]', 1, 0, 'Weibo'),
(4, 'add_weibo_comment', '添加轻博客评论', 1, 10, 'second', 'warning', 0, '', '[add_weibo_comment]', 1, 0, 'Weibo');
...
(222, 'admin', 2, 'Admin//Admin/Weibo/index', '轻博客', -1, ''),
...
(229, 'admin', 1, 'Admin/Weibo/editWeibo', '编辑轻博客', 1, ''),
...
(238, 'admin', 1, 'Admin/Weibo/weibo', '轻博客管理', 1, ''),
(239, 'admin', 1, 'Admin/Rank/index', '头衔列表', 1, ''),
(240, 'admin', 1, 'Admin/Forum/forumTrash', '板块回收站', -1, ''),
(241, 'admin', 1, 'Admin/Weibo/weiboTrash', '轻博客回收站', 1, ''),
...
(250, 'admin', 2, 'Admin/Weibo/weibo', '轻博客', 1, ''),
...
(280, 'admin', 1, 'Admin/Weibo/config', '轻博客设置', 1, ''),
...
(340, 'Weibo', 1, 'Weibo/Index/doSend', '发轻博客', 1, ''),
(297, 'Home', 1, 'deleteLocalComment', '删除本地评论', 1, ''),
(306, 'Issue', 1, 'addIssueContent', '专辑投稿权限', 1, ''),
(307, 'Issue', 1, 'editIssueContent', '编辑专辑内容（管理）', 1, ''),
(339, 'Weibo', 1, 'Weibo/Index/doDelWeibo', '删除轻博客(管理)', 1, ''),
(338, 'Weibo', 1, 'Weibo/Index/doSendRepost', '转发轻博客', 1, ''),
...
(341, 'Weibo', 1, 'Weibo/Index/doComment', '评论轻博客', 1, ''),
(342, 'Weibo', 1, 'Weibo/Index/doDelComment', '删除评论轻博客(管理)', 1, ''),
(343, 'Weibo', 1, 'Weibo/Index/setTop', '轻博客置顶(管理)', 1, ''),
...
(418, 'admin', 1, 'Admin/Weibo/setWeiboTop', '置顶轻博客', 1, ''),
(419, 'admin', 1, 'Admin/Weibo/setWeiboStatus', '设置轻博客状态', 1, ''),
(420, 'admin', 1, 'Admin/Weibo/setCommentStatus', '设置轻博客评论状态', 1, ''),
...
(2, 0, '轻博客', 'Weibo/index/index', 2, 0, 0, 1, 0, '#000000', '#000000', '', 'quote-left'),
...
(1001, '_CONFIG_WEB_SITE_NAME', 0, '', 0, '', '', 1427339647, 1427339647, 1, 'Onethin1P v3.1社交系统', 0),
...
(1005, '_CONFIG_ABOUT_US', 0, '', 0, '', '', 1427339647, 1427339647, 1, '<p>&nbsp; MarketMemory信息科技有限公司是一家专注于为客户提供专业的社交方案。公司秉持简洁、高效、创新，不断为客户创造奇迹。旗下产品有OneThin1P开源社交系统和OpenCenter开源用户和后台管理系统。</p>', 0),
(1006, '_CONFIG_SUBSCRIB_US', 0, '', 0, '', '', 1427339647, 1427339647, 1, '<p>业务QQ：276905621</p><p>联系地址：3751 jcombs 电子商务中心</p><p>联系电话：+1 778-7127299</p>', 0),
(1007, '_CONFIG_COPY_RIGHT', 0, '', 0, '', '', 1427339647, 1427339647, 1, '<p>Copyright ©2013-2014 <a href="http://www.marketmemory.com" target="_blank">BeiMeiBang信息科技有限公司</a></p>', 0),
(1008, '_HOME_LOGO', 0, '', 0, '', '', 1432791820, 1432791820, 1, '', 0),
(1009, '_HOME_ENTER_URL', 0, '', 0, '', '', 1432791820, 1432791820, 1, '', 0),
(1010, '_HOME_BLOCK', 0, '', 0, '', '', 1432791820, 1432791820, 1, '[{"data-id":"disable","title":"禁用","items":[]},{"data-id":"enable","title":"启用","items":[{"data-id":"slider","title":"轮播"},{"data-id":"Weibo","title":"轻博客"},{"data-id":"People","title":"会员展示"}]}]', 0),
...
(48, 'weiboType', '轻博客类型', 1, 1409121894, ''),
...
(56, 'beforeSendWeibo', '在发轻博客之前预处理轻博客', 2, 1408084504, 'InsertFile'),
(57, 'beforeSendRepost', '转发轻博客前的预处理钩子', 2, 1408085689, ''),
(58, 'parseWeiboContent', '解析轻博客内容钩子', 2, 1409121261, ''),
(59, 'userConfig', '用户配置页面钩子', 1, 1417137557, 'SyncLogin'),
(60, 'weiboSide', '轻博客侧边钩子', 1, 1417063425, 'Retopic,Recommend'),
...
(10002, '轻博客', 0, 8, 'Weibo/weibo', 1, '', '', 0, '', 'Weibo'),
(10003, '轻博客管理', 10002, 1, 'Weibo/weibo', 0, '', '轻博客', 0, '', 'Weibo'),
(10004, '回复管理', 10002, 3, 'Weibo/comment', 0, '', '回复', 0, '', 'Weibo'),
(10005, '编辑轻博客', 10002, 0, 'Weibo/editWeibo', 1, '', '', 0, '', 'Weibo'),
(10006, '编辑回复', 10002, 0, 'Weibo/editComment', 1, '', '', 0, '', 'Weibo'),
(10007, '轻博客回收站', 10002, 2, 'Weibo/weiboTrash', 0, '', '轻博客', 0, '', 'Weibo'),
(10008, '回复回收站', 10002, 4, 'Weibo/commentTrash', 0, '', '回复', 0, '', 'Weibo'),
(10009, '轻博客设置', 10002, 0, 'Weibo/config', 0, '轻博客的基本配置', '设置', 0, '', 'Weibo'),
(10010, '话题管理', 10002, 0, 'Weibo/topic', 0, '轻博客的话题', '话题管理', 0, '', 'Weibo'),
(10011, '置顶轻博客', 10002, 0, 'Weibo/setWeiboTop', 1, '', '', 0, '', 'Weibo'),
(10012, '设置轻博客状态', 10002, 0, 'Weibo/setWeiboStatus', 1, '', '', 0, '', 'Weibo'),
(10013, '设置轻博客评论状态', 10002, 0, 'Weibo/setCommentStatus', 1, '', '', 0, '', 'Weibo'),
...
(4, 'Weibo', '轻博客', '2.0.0', 0, 1, '轻博客模块，用户可以发布轻博客', '嘉兴想天信息科技有限公司', 'http://www.ourstu.com', 'Weibo/index/index', 1, 0, 'quote-left', 1, 'Admin/Weibo/weibo');
...
(1019, '轻博客首页', 'Weibo', 'Index', 'index', 1, '{$MODULE_ALIAS}', '{$MODULE_ALIAS}首页', '{$MODULE_ALIAS}-{$website_name}', 0, 'title：我关注的、热门轻博客、全站关注'),
(1020, '某条轻博客的详情页', 'Weibo', 'Index', 'weibodetail', 1, '{$weibo.title|text},{$website_name},{$MODULE_ALIAS}', '{$weibo.content|text}', '{$weibo.content|text}——{$MODULE_ALIAS}', 0, 'weibo:轻博客变量集\n   weibo.user.nickname 发布者昵称\n   weibo.content 轻博客内容'),
(1021, '轻博客搜索页面', 'Weibo', 'Index', 'search', 1, '', '', '', 0, 'search_keywords：搜索关键词'),
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='置顶轻博客表';
