...
{
    return M('Common/User')->query_user($fields, $uid);
}

function read_query_user_cache($uid, $field)
{

    return M('Common/User')->read_query_user_cache($uid, $field);
}

function write_query_user_cache($uid, $field, $value)
{
    return M('Common/User')->write_query_user_cache($uid, $field, $value);
}
...
{
    M('Common/User')->clean_query_user_cache($uid, $field);
}