    ...
    public function  _initialize()
    {
        $sub_menu =
            array(
                'left' =>
                    array(
                        array('tab' => 'index', 'title' => '首页', 'href' => U('Store/Index/index')),
                        array('tab' => 'li', 'title' => '商品', 'href' => U('Store/Index/li',array('name'=>'good'))),
                ...
                'right' =>
                    array(
                        array('tab'=>'createshop','title' => '<i class="icon-signin"></i> 店铺入驻', 'href' =>is_login()?U('Store/Center/createShop',array('name'=>'shop')):"javascript:toast.error('登录后才能操作')"),
                    )
            );
        $this->assign('menu_list', $sub_menu);
        $this->assign('top_tab',CONTROLLER_NAME=='Center'?'myStore':ACTION_NAME);
    }
