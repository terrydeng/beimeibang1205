-- -----------------------------
-- 表结构 `ocenter_store_adv`
-- -----------------------------
CREATE TABLE IF NOT EXISTS `ocenter_store_adv` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='首页广告轮播图';
...
CREATE TABLE IF NOT EXISTS `ocenter_store_shop` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='商店表';
...
INSERT INTO `ocenter_store_category` VALUES ('65', '发多少功夫', '1', '0', '', '1', '0');
INSERT INTO `ocenter_store_category` VALUES ('66', 'd丰富的撒', '1', '65', '', '1', '0');
-- -----------------------------
