...
class InviteModel extends Model
{
    ...
    public function createCodeAdmin($data = array(), $num = 1)
    {
        ...
        $invite_type = M('Ucenter/InviteType')->getSimpleList($map, 'length,time');
    ...
    public function backCode($id = 0)
    {
        ...
        if ($result) {
            ...
            if ($num > 0) {
                ...
                $map['uid'] = $invite['uid'];
                M('InviteUserInfo')->where($map)->setDec('already_num', $num);
                M('InviteUserInfo')->where($map)->setInc('num', $num);
            }
        }
        return $result;
    }
    ...
    private function _initSelectData($dataList = array())
    {
        ...
        $invite_types = M('Ucenter/InviteType')->getSimpleList($map);
