...
class LocalCommentModel extends Model
{
    public function addIssueComment($uid, $aIssueId, $aContent, $comment_id = 0)
    {
        ...
        //增加轻博客评论数量
        D('IssueContent')->where(array('id' => $aIssueId))->setInc('reply_count');
    ...
    {
        //获取轻博客编号
        $issueCommentModel=M('LocalComment');
        ...
        //减少专辑的评论数量
        M('IssueContent')->where(array('id' => $issue_id))->setDec('reply_count');
    ...
    public function addBlogComment($uid, $aBlogId, $aContent, $comment_id = 0)
    {
        ...
        //增加轻博客评论数量
        D('IssueContent')->where(array('id' => $aBlogId))->setInc('reply_count');
