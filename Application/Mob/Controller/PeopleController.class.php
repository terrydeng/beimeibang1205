...
class  PeopleController extends BaseController
{
    public function index()
    {
        ...
        if (empty($peoples)) {
            $peoples = M('Member')->where($map)->field('uid', 'reg_time', 'last_login_time')->order('last_login_time desc')->findPage(20,false,array(),4);
    ...
    private function setMap()
    {
        ...
        if ($aTag) {
            ...
            $links = M('Ucenter/UserTagLink')->getListByMap($map_uids);
