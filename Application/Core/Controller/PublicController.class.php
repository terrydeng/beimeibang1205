...
class PublicController extends Controller
{
    ...
    private function getAtWhoUsers()
    {
        //获取能AT的人，UID列表
        $uid = get_uid();
        $follows = M('Follow')->where(array('who_follow' => $uid, 'follow_who' => $uid, '_logic' => 'or'))->select();
        $uids = array();
    ...
    public function getVideo(){
        $aLink = I('post.link');
        $this->ajaxReturn(array('data'=>M('ContentHandler')->getVideoInfo($aLink)));
    }
