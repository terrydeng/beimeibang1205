...
class AttributeController extends AdminController {
    ...
    public function add(){
        $model_id   =   I('get.model_id');
        $model      =   D('Model')->field('title,name,field_group')->find($model_id);
    ...
    public function edit(){
        ...
        $model  =   D('Model')->field('title,name,field_group')->find($data['model_id']);
        $this->assign('model',$model);
    ...
    public function update(){
        $res = M('Attribute')->update();
        if(!$res){
            $this->error(M('Attribute')->getError());
        }else{
