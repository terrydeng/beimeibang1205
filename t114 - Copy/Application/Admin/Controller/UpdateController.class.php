...
class UpdateController extends AdminController{
	...
	private function update($version){
		...
		$this->showMsg('系统原始版本:'.PhPluSer_VERSION);
		$this->showMsg('PhPluSer在线更新日志：');
		...
		$params = array('version' => PhPluSer_VERSION);
		...
		$file = str_replace(PhPluSer_VERSION, $version, $file);
