...
// BeiMeiBang常量定义
const BeiMeiBang_VERSION    = '1.1.141101';
const BeiMeiBang_ADDON_PATH = './Addons/';
 ...
 * @return string         分类信息
 */
function get_categor1y2school($id, $field = null){
    static $list;
...
function get_model_attribute($model_id, $group = true,$fields=true){
    ...
    if(!isset($list[$model_id])){
        ...
        $info = D('Attribute')->where($map)->field($fields)->select();
        $list[$model_id] = $info;
    }
    ...
    if($group){
        ...
        $model     = D("Model")->field("field_sort,attribute_list,attribute_alias")->find($model_id);
