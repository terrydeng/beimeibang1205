...
return array(
    /* 数据缓存设置 */
    'DATA_CACHE_PREFIX'    => 'BeiMeiBang_', // 缓存前缀
    ...
    'UPLOAD_QINIU_CONFIG'=>array(
        ...
        'bucket'=>'BeiMeiBangtest',
        'domain'=>'BeiMeiBangtest.u.qiniudn.com',
        'timeout'=>3600,
    ),
    ...
    /* SESSION 和 COOKIE 配置 */
    'SESSION_PREFIX' => 'BeiMeiBang_admin', //session前缀
    'COOKIE_PREFIX'  => 'BeiMeiBang_admin_', // Cookie前缀 避免冲突
