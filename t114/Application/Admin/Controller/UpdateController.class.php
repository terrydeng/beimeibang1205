...
class UpdateController extends AdminController{
	...
	private function checkVersion(){
		if(extension_loaded('curl')){
			$url = 'http://www.phplus.info/index.php?m=home&c=check_version';
			$params = array(
					'version' => BeiMeiBang_VERSION,
	...
	private function update($version){
		...
		$this->showMsg('系统原始版本:'.BeiMeiBang_VERSION);
		$this->showMsg('BeiMeiBang在线更新日志：');
		...
		/* 获取更新包 */
		//获取更新包地址
		$updatedUrl = 'http://www.phplus.info/index.php?m=home&c=check_version&a=getDownloadUrl';
		$params = array('version' => BeiMeiBang_VERSION);
		...
		$file = str_replace(BeiMeiBang_VERSION, $version, $file);
