...
<div class="block-bar weibo">
    <div class="container">
		<div class="social section-title">		
			海外求学社交网络
		</div>
		<div class="social section-subtitle">
			最可信赖的社区
		</div>
        <div class="block-body row">
            <div class="col-xs-6 right-border">
                <div class="common-block weibo">
                    <div class="section-title light-blog">
                                                ...
                                                <div class="" style="padding: 10px 10px 5px 10px">
                                                    ...
                                                    <div class="col-md-10" style="padding: 5px">
                                                        ...
                                                        <div class="weibo_content_p">
                                                            <?php echo ($weibo["fetchContent"]); ?>  <!-- 最新轻博1客2<?php echo ($weibo["fetchContent"]); ?> -->
                    <span>
