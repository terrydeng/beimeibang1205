...
!function t(e, i, n) {
    ...
    1: [function (t, e) {
        (function (i) {
            ...
            o(function () {
                n()
            }), e.exports = o.AMUI.accordion = {VERSION: "2.0.1", init: n}
        ...
        (function (i) {
            ...
            function n() {
                o(".am-figure").each(function (t, e) {
                    ...
                    if (i.pureview)if ("auto" === i.pureview) {
            ...
            o.isImgZoomAble = function (t) {
                ...
                n()
            }), e.exports = o.AMUI.figure = {VERSION: "2.0.2", init: n}
        }).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
        ...
        (function (i) {
            "use strict";
            function n() {
                var t = s('[data-am-widget="gallery"]'), e = t.filter(".am-gallery-one");
                t.each(function () {
            ...
            s(function () {
                n()
            }), e.exports = s.AMUI.gallery = {VERSION: "2.0.2", init: n}
        }).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
        ...
        (function (i) {
            ...
            t("./core"), s(function () {
                n()
            }), e.exports = s.AMUI.listNews = {VERSION: "3.0.2", init: n}
        }).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
        ...
        (function (i) {
            ...
            n(function () {
                s()
            }), e.exports = n.AMUI.menu = {VERSION: "4.0.2", init: s}
        }).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
        ...
        (function (i) {
            ...
            c.DEFAULTS = {
                ...
                if (!this.active && this.$element.length) {
                    ...
                    var u = function () {
                        e.trigger(o.Event("opened.modal.amui", {relatedTarget: t})), this.transitioning = 0
                    };
        ...
        (function (i) {
            ...
            a.DEFAULTS = {
                ...
                var e = this.$element, i = this.options, n = [], a = e.find("optgroup");
                e.hide(), a.length ? a.each(function (e) {
                    n.push({header: !0, group: e + 1, text: this.label}), a.eq(e).find("option").each(function (i, n) {
                        t(i, n, e)
                    })
                ...
                var l = this.$selector.find(".am-selected-btn").css({width: this.options.btnWidth}), c = [];
                i.btnSize && c.push("am-btn-" + i.btnSize), i.btnStyle && c.push("am-btn-" + i.btnStyle), l.addClass(c.join(" ")), this.$selector.dropdown({justify: l}), i.maxHeight && this.$selector.find(".am-selected-list").css({
                    "max-height": i.maxHeight,
                    "overflow-y": "scroll"
                });
                var u = [], d = e.attr("minchecked"), h = e.attr("maxchecked");
                ...
                var t = this, e = s.utils.debounce(function (e) {
        ...
        (function (i) {
            ...
            l.DEFAULTS = {
                ...
                tqq: {title: "腾讯轻博客", url: "http://v.t.qq.com/share/share.php", icon: "tencent-weibo"},
        ...
        (function (i) {
            ...
            a.DEFAULTS = {
                ...
                var t = this.check();
                if (!t)return !1;
                var e = this.$element, i = o('<div class="am-sticky-placeholder"></div>').css({
        ...
        (function (i) {
            ...
            a.DEFAULTS = {
                ...
                var t = this, e = this.$element, i = this.options, n = e.find(i.allFields), s = [], a = !0, r = [], l = o([]);
                ...
                var u = {valid: a, $invalidFields: l, validity: r};
        ...
        (function (t) {
            ...
            var n = "undefined" != typeof window ? window.jQuery : "undefined" != typeof t ? t.jQuery : null, o = navigator.userAgent.indexOf("Android") > 0, s = /iP(ad|hone|od)/.test(navigator.userAgent), a = s && /OS 4_\d(_\d)?/.test(navigator.userAgent), r = s && /OS ([6-9]|\d{2})_\d/.test(navigator.userAgent), l = navigator.userAgent.indexOf("BB10") > 0;
            i.prototype.needsClick = function (t) {
                ...
                return new i(t, e)
            }, n && (n.AMUI ? n.AMUI.FastClick = i : n.AMUI = {FastClick: i}), e.exports = i
        }).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
    }, {}], 49: [function (t, e) {
        (function (i) {
            "use strict";
        ...
        (function (i) {
            ...
            function D(t, e) {
                ...
                if (e.eventType != Ae && (r > Ce || void 0 === a.velocity)) {
                    var l = a.deltaX - e.deltaX, c = a.deltaY - e.deltaY, u = I(r, l, c);
            ...
            var _e = {mousedown: Ee, mousemove: ke, mouseup: Se}, je = "mousedown", Ue = "mousemove mouseup";
            l(z, C, {
                handler: function (t) {
                    var e = _e[t.type];
            ...
            var Re = {pointerdown: Ee, pointermove: ke, pointerup: Se, pointercancel: Ae, pointerout: Ae}, qe = {
                2: ye,
                3: be,
                4: Te,
                5: xe
            ...
            window.MSPointerEvent && (We = "MSPointerDown", Be = "MSPointerMove MSPointerUp MSPointerCancel"), l(_, C, {
                handler: function (t) {
                    var e = this.store, i = !1, n = t.type.toLowerCase().replace("ms", ""), o = Re[n], s = qe[t.pointerType] || t.pointerType, a = s == ye, r = g(e, t.pointerId, "pointerId");
