...
class ForumPostModel extends Model {
    ...
    public function createPost($data) {
        ...
        //增加板块的帖子数量
        M('Forum')->where(array('id'=>$data['forum_id']))->setInc('post_count');
    ...
    {
        M('ContentHandler')->handleAtWho($content,'Forum/Index/detail',array('id'=>$id));
    ...
    {
        $forum_key_value = M('Forum')->getForumKeyValue();
        foreach ($list as &$v) {
