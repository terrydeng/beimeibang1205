...
class FollowModel extends Model
{
    ...
    public function follow($uid)
    {
        ...
        M('Message')->sendMessage($uid, L('_FANS_NUMBER_INCREASED_'), $user['nickname'] . L('_CONCERN_YOU_WITH_PERIOD_'), 'Ucenter/Index/index', array('uid' => is_login()));
    ...
    public function unfollow($uid)
    {
        ...
        M('Message')->sendMessage($uid, L('_NUMBER_OF_FANS_'), $user['nickname'] . L('_CANCEL_YOUR_ATTENTION_WITH_PERIOD_'), 'Ucenter/Index/index', array('uid' => is_login()));
    ...
    public function isFollow($who_follow, $follow_who)
    {
        ...
        if ($follow === false) {
            $follow = M('Follow')->where(array('who_follow' => $who_follow, 'follow_who' => $follow_who))->count();
            $follow++;
    ...
    public function addFollow($who_follow, $follow_who, $invite = 0)
    {
        ...
        M('Message')->sendMessage($follow_who, L('_FANS_NUMBER_INCREASED_'), $content, 'Ucenter/Index/index', array('uid' => $who_follow), $who_follow);
