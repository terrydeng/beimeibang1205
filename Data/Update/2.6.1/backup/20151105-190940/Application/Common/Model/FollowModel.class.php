...
class FollowModel extends Model
{
    ...
    public function follow($uid)
    {
        ...
        M('Message')->sendMessage($uid, '粉丝数增加', $user['nickname'] . ' 关注了你。', 'Ucenter/Index/index', array('uid' => is_login()));
    ...
    public function unfollow($uid)
    {
        ...
        M('Message')->sendMessage($uid, '粉丝数减少', $user['nickname'] . ' 取消了对你的关注。', 'Ucenter/Index/index', array('uid' => is_login()));
